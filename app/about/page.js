...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-white py-24 h-screen flex items-center justify-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mb-8 text-lg text-lawas-body">
      ...
      {/* Partners Section */}
      <section id="partners-section" className="bg-lawas-light py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            <div className="relative">
              ...
              <div className="absolute -left-2 sm:-left-8 -top-6 sm:-top-8">
                <Image
                  ...
                  width={40}
                  height={40}
                  className="opacity-20 sm:w-[60px] sm:h-[60px]"
                />
              </div>
