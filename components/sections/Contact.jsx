...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_j08z5ym', 'template_vyvmloe', form.current, {
        publicKey: 'KjxcrCnFmlp8Ns9UK',
      })
      .then(
        () => {
          console.log('SUCCESS!');
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div className="animate-fade-in rounded-lg bg-white/5 p-6 shadow-lg backdrop-blur-sm">
              <h3 className="text-lg md:text-lg font-bold text-lawas-accent mb-6 text-center uppercase tracking-wider py-4 px-6 rounded-lg shadow-lg border-2 border-yellow-500/20 transform hover:scale-105 transition-transform duration-300">Get Free Legal Consultation</h3>
              {showSuccess ? (
